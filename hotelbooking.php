...
<?php
	if(isset($_POST["filter"])){
		if(!empty($_POST["check_list"])){
			...
			//echo $selected1;
			$url = "https://tripadvisor1.p.rapidapi.com/hotels/list?amenities=$selected1&checkin=2020-02-08&location_id=$search1&adults=1&rooms=1";
			//echo $url;
		}
		
	}
	else{
		$url = "https://tripadvisor1.p.rapidapi.com/hotels/list?checkin=2020-02-08&location_id=$search1&adults=1&rooms=1";
	}
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar1">
                    <ul class="nav navbar-nav navbar-right navbar-search-link">
                        ...
                        <li class="dropdown"><a href="hotelbooking.php" class="active">Hotels</a>
                                        ...
                                        <div id="panel-2" class="panel-collapse collapse">
                                            <div class="panel-body text-left">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li class="custom-check"><input type="checkbox" id="check09" name="check_list[]" value="free_internet"/>
                                                    <label for="check09"><span><i class="fa fa-check"></i></span>Free Internet</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check10" name="check_list[]" value="swimming_pool"/>
                                                    <label for="check10"><span><i class="fa fa-check"></i></span>Swimming Pool</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check11" name="check_list[]" value="free_breakfast"/>
                                                    <label for="check11"><span><i class="fa fa-check"></i></span>Free Breakfast</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check12" name="check_list[]" value="Spa"/>
                                                    <label for="check12"><span><i class="fa fa-check"></i></span>Spa</label></li>
                                                    <li class="custom-check"><input type="checkbox" id="check13" name="check_list[]" value="bar_lounge"/>
                                                    <label for="check13"><span><i class="fa fa-check"></i></span>Bar/Lounge</label></li> 
                                                </ul>
                                            </div><!-- end panel-body -->
...
//print_r($result);
	 ...
	 foreach($resultdata as $final){
		...
		$hotel_image= isset($res['url'])?$res['url']:null;
		$hotel_price= isset($final['price'])?$final['price']:null;
		$address=isset($final['ranking'])?$final['ranking']:null;
		$rating=isset($final['rating'])?$final['rating']:null;
		$hotel_id=isset($final['location_id'])?$final['location_id']:null;
		  ...
		  <div class="list-block1 main-block1" style="height: 200px; width: 80%">
								...
								<tr>
                                    ...
                                    <td width="70%" style="margin_left:20px;">
                                        <h3 class="block-title"><a href="#">$hotel_name</a></h3>
                                        <p class="block-minor"> Prices starting from <b>$hotel_price</b></p>
                                        <p><b>$address</b></p>
										<form method="post" action="hotel_details.php"> 
									   <input type="hidden" name="rest_id" value= $hotel_id  />
